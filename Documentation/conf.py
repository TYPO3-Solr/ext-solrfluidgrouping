...
project = u'Documentation for EXT:solrfluidgrouping grouping for EXT:solr'
copyright = u'since 2018 by dkd'
...
pdf_documents = [
    ('Index', 'solr', u'Documentation for EXT:solrfluidgrouping grouping for EXT:solr',
     u'Timo Hund'),
]
...
texinfo_documents = [
    ('Index', 'solr', u'Documentation for EXT:solrfluidgrouping grouping for EXT:solr',
     u'Timo Hund', 'Documentation for EXT:solrfluidgrouping grouping for EXT:solr', 'One line description of project.',
     'Miscellaneous'),
]
