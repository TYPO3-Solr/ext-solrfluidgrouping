...
namespace ApacheSolrForTypo3\Solrfluidgrouping\ViewHelpers;
...
class GroupItemPaginateViewHelper extends AbstractSolrViewHelper
{
    ...
    protected function getTemplateObject(): StandaloneView
    {
        ...
        $layoutRootPaths = [];
        $layoutRootPaths[] = GeneralUtility::getFileAbsFileName('EXT:solrfluidgrouping/Resources/Private/Layouts/ViewHelpers/');
        ...
        $partialRootPaths = [];
        $partialRootPaths[] = GeneralUtility::getFileAbsFileName('EXT:solrfluidgrouping/Resources/Private/Partials/ViewHelpers/');
        ...
        $templateRootPaths = [];
        $templateRootPaths[] = GeneralUtility::getFileAbsFileName('EXT:solrfluidgrouping/Resources/Private/Templates/ViewHelpers/');
